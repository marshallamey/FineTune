const AttrDesc = {
  ...
  ac: {
    name: 'Acousticness',
    description: 'A confidence measure from 0 to 100 of whether the track is '
  ...
  en: {
    name: 'Energy',
    description: 'Energy is a measure from 0 to 100 and represents a perceptual '
  ...
  val: {
    name: 'Valence',
    description: ' A measure from 0 to 100 describing the musical positiveness '
  ...
  key: {
    name: 'Key',
    description: 'The key the track is in.  By default, this option is disabled.'
      + 'Use the checkbox to choose a key.',
  },
  mode: {
    name: 'Mode',
    description: 'Mode indicates the modality (major or minor) of a track, the type of '
      + 'scale from which its melodic content is derived. '
      + 'By default, this option is disabled. Use the checkbox to choose a mode.',
  },
};

export default AttrDesc;
