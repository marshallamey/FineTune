...
class App extends React.Component {
  componentDidMount() {
    ...
    let tokens;
    if (!spotifyTokens.access_token) { tokens = areTokensAvailable(this.props); }
    if (tokens) { connectToSpotify(this.props, tokens); }
  ...
  render() {
    console.log('FINETUNEAPP(App):: Rendering with these props ==> ', this.props);
